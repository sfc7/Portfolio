...
void APlayerCharacter::Destroyed()
{
	...
	if (HasAuthority()) {
		...
		UKismetSystemLibrary::PrintString(this, FString::Printf(TEXT("Destroyed")), true, true, FLinearColor::Yellow, 10.0f);
	}
	else {
...
{
	UpdateDestroyedActor();
	UKismetSystemLibrary::PrintString(this, FString::Printf(TEXT("UpdateDestroyedActor_Client")), true, true, FLinearColor::Yellow, 10.0f);
}
